...
@Component({
  ...
  template:`
    ...
    <section class="panel table-wrap">
      <table><thead><tr><th>Score</th><th>Intent</th><th>Source</th><th>Temperature</th><th>Status</th><th>Est. value</th><th>Action</th></tr></thead>
...
export class LeadsPage implements OnInit{
  rows:any[]=[]; contacts:any[]=[]; q=''; temp=''; showCreate=false;
  form:any={contactId:'',source:'manual',score:50,estimatedValue:0,intentSummary:''};
  constructor(private data:CrmService){}
  ngOnInit(){this.load()}
  load(){this.data.leads().subscribe(r=>this.rows=r);this.data.contacts().subscribe(r=>this.contacts=r)}
